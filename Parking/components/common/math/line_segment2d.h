#ifndef COMMON_MATH_LINE_SEGMENT2D_H_
#define COMMON_MATH_LINE_SEGMENT2D_H_
...
public:
   ...
   */
    ...
    /**
   * @brief Get the theta of the line segment.
   * @return The theta, which is the angle between unit direction and x-axis.
   */
    double theta() const { return theta_; }

    /**
   * @brief Get the cosine of the theta.
   * @return The cosine of the theta.
   */
    double cos_theta() const { return unit_direction_.x(); }

    /**
   * @brief Get the sine of the theta.
   * @return The sine of the theta.
   */
    double sin_theta() const { return unit_direction_.y(); }

#ifndef PLANNING_MOTION_POLY_SPEED_PLAN_SPEED_PROFILE_H_
#define PLANNING_MOTION_POLY_SPEED_PLAN_SPEED_PROFILE_H_
...
class SpeedProfile : public Curve1d
{
public:
    explicit SpeedProfile(std::shared_ptr<Curve1d> ptr_curve);
...
private:
    std::shared_ptr<Curve1d> ptr_speed_profile_;

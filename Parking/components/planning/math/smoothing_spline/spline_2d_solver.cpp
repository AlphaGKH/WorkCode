...
bool Spline2dSolver::Solve() {
    ...
    bool use_hotstart =
            ...
            (sqp_solver_ != nullptr && num_param == last_num_param_ && num_constraint == last_num_constraint_);
    ...
    CHECK_EQ(index, kernel_matrix.rows() * kernel_matrix.cols());
    ...
    CHECK_EQ(index, equality_constraint_matrix.rows() * num_param);

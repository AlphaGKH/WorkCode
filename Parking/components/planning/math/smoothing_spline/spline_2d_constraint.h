...
#ifndef PLANNING_MATH_SMOOTHING_SPLINE_SPLINE_2D_CONSTRAINT_H_
#define PLANNING_MATH_SMOOTHING_SPLINE_SPLINE_2D_CONSTRAINT_H_
...
public:
   ...
   **/
    bool Add2dBoundary(const std::vector<double>& t_coord,
                       ...
                       const std::vector<common::math::Vec2d>& ref_point,
...
private:
    ...
    double SignDistance(const common::math::Vec2d& xy_point,

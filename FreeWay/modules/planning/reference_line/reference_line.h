...
public:
  bool Shrink(const common::math::Vec2d &point, const double distance_backward,
              const double &distance_forward);

private:
  bool Shrink(const double s, const double distance_backward,
              const double distance_forward);
...
private:
  ...
  ReferencePoint
  InterpolateWithMatchedIndex(const ReferencePoint &p0, const double s0,

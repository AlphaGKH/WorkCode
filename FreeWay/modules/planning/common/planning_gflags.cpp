...
DEFINE_string(traffic_rule_config_filename,
              "/dharma/modules/planning/conf/traffic_rule_config.pb.txt",
              "Traffic rule config filename");

DEFINE_string(smoother_config_filename,
              "/dharma/modules/planning/conf/qp_spline_smoother_config.pb.txt",
...
DEFINE_string(planning_config_file,
              "/dharma/modules/planning/conf/planning_config.pb.txt",
              "planning config file");
...
DEFINE_string(planner_open_space_config_filename,
              "/dharma/modules/planning/conf/planner_open_space_config.pb.txt",
